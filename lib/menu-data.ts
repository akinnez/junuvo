...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'pay-bills', label: 'Pay Bills', icon: Receipt, submenu: [
    { id: 'airtime', label: 'Airtime & Data', icon: Banknote, href: '/account/bills/internet/airtime' },
    { id: 'electricity', label: 'Electricity', icon: Banknote, href: '/account/bills/electricity/prepaid' },
    { id: 'cabletv', label: 'Cable TV', icon: Banknote, href: '/account/bills/cabletv' },
    { id: 'betting', label: 'Betting', icon: Banknote, href: '/account/bills/betting' },
    { id: 'flights', label: 'Flights', icon: Banknote, href: '/account/bills/flight/route?type=one-way' },
    { id: 'giftcards', label: 'Giftcards', icon: Banknote, href: '/account/bills/giftcard' },
