...
export const FlightOneWayCard: React.FC<{ flight: FlightData }> = ({
  ...
  return (
    <Card className="!shadow-2xs !p-5 overflow-hidden w-full hover:shadow-primary hover:!shadow transition-shadow  duration-300 cursor-pointer">
      ...
      <div className="flex justify-between items-center pt-3 text-[10px]">
        ...
        <button
          ...
          className="text-[#860495] font-bold focus:outline-none focus:ring-2"
        >
          View details
        </button>
      </div>
